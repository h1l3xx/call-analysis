-- =============================================================================
-- V10: Add phone_number to managers for bulk-upload caller matching
-- =============================================================================

-- Existing dev tenant
ALTER TABLE tenant_dev_clinic.managers ADD COLUMN IF NOT EXISTS phone_number TEXT;
CREATE INDEX IF NOT EXISTS idx_tenant_dev_clinic_managers_phone
    ON tenant_dev_clinic.managers (phone_number) WHERE phone_number IS NOT NULL;

-- Seed phone numbers for dev managers
UPDATE tenant_dev_clinic.managers SET phone_number = '79001112233'
    WHERE id = '00000000-0000-0000-0002-000000000001';
UPDATE tenant_dev_clinic.managers SET phone_number = '79004445566'
    WHERE id = '00000000-0000-0000-0002-000000000002';

-- Update create_tenant_schema to include phone_number for new tenants
